...
export class SagitComponent implements OnInit {
  constructor(
    private sagitService: PropertyService,
    ...
    this.route.paramMap.subscribe((param) => {
      if (param.get('edit')) {
        ...
        if (this.sagitService.userProperties !== undefined) {
          this.editedProp = this.sagitService.userProperties.filter(
            (prop: any) => {
          ...
          setTimeout(() => {
            //this is to validate other prop type in setPropertyType method
            this.setPropertyType(propEditType);
          }, 50);
        } else {
          //fetch property from server if its a direct link to editing page
          this.sagitService
            .getProperties(propEditType + '/' + propEditID)
            .subscribe((res) => {
              this.editedProp = res;
      ...
      this.sagitHeaderMsg = this.isEditing
        ? 'Editing Property'
        : 'List and Get Deals';
    });
    if (!this.isEditing) {
  ...
  displayForm() {
    ...
    this.sagitForm = this.fb.group({
      sagitFormGroup: this.fb.array([
        ...
        this.fb.group({
          plots: [
            this.fetchedProp && this.editedProp.type == 'land'
              ? this.editedProp.land.plots
              : 1,
            [Validators.required, Validators.min(1), Validators.max(1000)],
          ],
          size: [
            this.fetchedProp && this.editedProp.type == 'land'
              ? this.editedProp.land.size.split('_')[0]
              : '2500',
            [Validators.required, Validators.min(50), Validators.max(1000000)],
          ],
          unit: [
            this.fetchedProp && this.editedProp.type == 'land'
              ? this.editedProp.land.size.split('_')[1]
              : '',
            [Validators.required],
          ],
          allocationType: [
            this.fetchedProp && this.editedProp.type == 'land'
              ? this.editedProp.land.allocation_type
              : '',
            [
              Validators.required,
              Validators.minLength(5),
        ...
        this.fb.group({
          totalRooms: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.total_rooms !== undefined
              ? this.editedProp.house.total_rooms
              : 1,
          ...
          bedrooms: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.bedrooms !== undefined
              ? this.editedProp.house.bedrooms
              : 1,
            [
              //Validators.required,
              Validators.min(0),
          ...
          bathrooms: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.bathrooms !== undefined
              ? this.editedProp.house.bathrooms
              : 1,
            [
              //Validators.required,
              Validators.min(0),
          ...
          parkingSpace: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.parking_space !== undefined
              ? this.editedProp.house.parking_space.toString()
              : '',
            [Validators.required],
          ],
          parkingSpaceSize: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.parking_space_size !== undefined
              ? this.editedProp.house.parking_space_size
              : 1,
          ...
          firstResident: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.first_resident !== undefined
              ? this.editedProp.house.first_resident.toString()
              : '',
            [Validators.required],
          ],
          furnishing: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.furnishing !== undefined
              ? this.editedProp.house.furnishing
              : '',
            [
              //Validators.required
            ],
          ...
          housingQuality: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.housing_quality !== undefined
              ? this.editedProp.house.housing_quality
              : '',
            [
              //Validators.required
            ],
          ...
          smoking: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.smoking !== undefined
              ? this.editedProp.house.smoking.toString()
              : '',
            [
              //Validators.required
            ],
          ...
          pets: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.pets !== undefined
              ? this.editedProp.house.pets.toString()
              : '',
            [
              //Validators.required
            ],
          ...
          parties: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.parties !== undefined
              ? this.editedProp.house.parties.toString()
              : '',
            [
              //Validators.required
            ],
          ...
          minimumRent: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.minimum_rent !== undefined
              ? this.editedProp.house.minimum_rent
              : '',
          ...
          water: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.water !== undefined
              ? this.editedProp.house.water
              : '',
            [Validators.required],
          ],
          light: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.light !== undefined
              ? this.editedProp.house.light
              : '',
            [Validators.required],
          ],
          fenced: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.fenced !== undefined
              ? this.editedProp.house.fenced
              : '',
            [
              Validators.required,
          ...
          facilities: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.facilities !== undefined
              ? this.editedProp.house.facilities
              : '',
          ...
          guestCapacity: [
            this.fetchedProp &&
            this.editedProp.type == 'house' &&
            this.editedProp.guest_capacity !== undefined
              ? this.editedProp.house.guest_capacity
              : '',
  ...
  removeImage(id: number, edited = false) {
    if (edited) {
      this.deletedImages.push(id);
      this.editedProp.property_image = this.editedProp.property_image.filter(
        (el: any) => {
          return el.id !== id;
        }
      );
      alert(`Image of ID: ${id} deleted.`);
    } else {
      console.log(`logging house step form control group`);
      console.log(this.houseStep);
      //console.log(`before filter and id is ${id}`)
  ...
  onImageSelected(event: any) {
    ...
    reader.onload = (e: any) => {
      this.selectedImages[this.selectedImages.length] = {
        uploadImage: targetImg,
        previewURL: e.target.result,
        id: this.selectedImages.length,
      };
  ...
  sagit() {
    ...
    let postData = Object.assign(
      {},
      propertyDetails.sagitFormGroup[0],
      propertyDetails.sagitFormGroup[propDetailIndex]
    );
    ...
    if (this.selectedImages.length) {
      for (let image of this.selectedImages) {
        propertyForm.append('images[]', image.uploadImage);
      }
    }
    ...
    //attach property type
    this.sagitService.postProperty(propertyForm).subscribe(
      (res) => {
